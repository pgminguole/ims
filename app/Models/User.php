...
{
    use HasApiTokens, HasFactory, Notifiable, SoftDeletes, HasRoles, HasAssetStatistics;
    ...
    public function scopeActive($query)
{
    ...
    // Alias for assignedRole to maintain compatibility with existing code
    public function role()
    {
        return $this->assignedRole();
    }

    // Accessor for role to avoid conflicts with scopeRole
    public function getRoleAttribute()
    {
        return $this->assignedRole;
    }

    // Helper method to check role (Renamed to avoid conflict with Spatie)
    public function hasAssignedRole($roleName)
    {
        return $this->assignedRole && $this->assignedRole->name === $roleName;
    }
