...
<div class="container-fluid p-xl-5">
    <div class="row mb-4">
        <div class="col">
            <h1 class="text-heading mb-0">Edit Court</h1>
            <p class="text-muted">Update court information</p>
        </div>
        <div class="col-auto">
            <div class="btn-group-compact">
                <a href="{{ route('courts.show', $court) }}" class="btn btn-outline-secondary btn-compact">
            ...
            <div class="form-grid">
                ...
                <div class="form-group form-group-full">
                    ...
                    <textarea class="form-control @error('address') is-invalid @enderror" 
                              name="address" rows="3" required>{{ old('address', $court->address) }}</textarea>
                    @error('address')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
